...
urlpatterns = [
    ...
    path("recurrent-transaction/", views.RecurrentTransactionCreateView.as_view(), name='recurrenttransaction_create'),
    path("recurrent-transaction/<int:pk>/", views.RecurrentTransactionUpdateView.as_view(), name='recurrenttransaction_update'),
    path("recurrent-transaction/<int:pk>/delete/", views.RecurrentTransactionDeleteView.as_view(), name='recurrenttransaction_delete'),
    path("recurrent-transactions/", views.RecurrentTransactionListView.as_view(), name='recurrenttransaction_list'),
    ...
    path("budgetconfigurations/", views.BudgetConfigurationListView.as_view(), name='budgetconfiguration_list'),
