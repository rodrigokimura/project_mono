...
class HealthcheckConfig(AppConfig):
    ...
    def ready(self):
        from finance.signals import initial_setup, group_initial_setup, installments_creation, round_transaction
        from accounts.signals import email_verification
        from finance.models import Group, Installment, Transaction
        User = get_user_model()
