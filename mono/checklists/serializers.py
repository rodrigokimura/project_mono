...
class ChecklistSerializer(ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        checklist.order = Checklist.objects.filter(
...
class ChecklistMoveSerializer(Serializer):
    ...
    def save(self, *args, **kwargs):
        ...
        """
        checklist = Checklist.objects.get(id=self.validated_data["checklist"])
...
class TaskMoveSerializer(Serializer):
    ...
    def save(self, *args, **kwargs):
        ...
        Apply task movement
        """
        task = Task.objects.get(id=self.validated_data["task"])
        order = self.validated_data["order"]
