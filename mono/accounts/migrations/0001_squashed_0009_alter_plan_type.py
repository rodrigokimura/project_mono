...
class Migration(migrations.Migration):
    ...
    replaces = [('accounts', '0001_initial'), ('accounts', '0002_auto_20210401_1751'), ('accounts', '0003_userprofile_verified_at'), ('accounts', '0004_alter_userprofile_id'), ('accounts', '0005_alter_userprofile_user'), ('accounts', '0006_notification'), ('accounts', '0007_alter_notification_options'), ('accounts', '0008_feature_plan_subscription'), ('accounts', '0009_alter_plan_type')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default=None, null=True, upload_to=accounts.models.user_directory_path)),
